...
#### 요구사항
    ...
    -create_user 함수를 호출한 결과를 출력하면 user_info 딕셔너리가 출력되어야 한다.
...
def increase_user():
    """호출할 때마다 유저수를 1 증가시키는 함수"""
    global number_of_people
    number_of_people += 1


def create_user(name, age, address):
    """인자를 받아 딕셔너리를 생성하고, increase_user 함수를 호출하여 유저수를 증가시킨 뒤
    환영 메세지를 출력하고 완성된 user_info를 반환하는 함수"""
...
result_2 = create_user('홍길동', 30 ,'서울')
print(result_2)
print(f'현재 가입 된 유저 수 : {number_of_people}')
...
def rental_book(name, number):
    """대여자 이름과 대여하는 책의 수를 인자로 decrease 함수를 호출하고
    완료 메세지를 출력하는 함수"""
...
def decrease_book(count):
    """넘겨받은 책의 수만틈 number_of_book을 감소시키고 남은 책의 수를
    출력하는 함수
    >>> decrease_book(5)
    현재 남은 책의 수 : 95
    """    
